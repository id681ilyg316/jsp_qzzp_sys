...
public class Info {
	...
	System.out.print(Info.getBetweenDayNumber("2012-11-11 11:19", "2012-11-11 11:11"));
	 ...
	 public static void writeExcel(String fileName,String prosstr,java.util.List<List> list,HttpServletRequest request, HttpServletResponse response){    
	        ...
	        try {
				response.sendRedirect("/qzzp_sys/upload?filename="+fileName.substring(fileName.lastIndexOf("/")+1));
			} catch (IOException e) {
				e.printStackTrace();
			}
	 ...
	 public static String getFileUpInfo()
		{
			String jscode = "";
			jscode+="<script src=/qzzp_sys/js/popup.js></script>";
	  ...
	  public static String tform(HashMap map)
		{
	    	...
	    	Set set = map.entrySet();
	    	 ...
	    	 jscode+=" if(f1."+str1+")\n";
	    	  ...
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt\").src=\"/qzzp_sys/upfile/"+map.get("filename")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt2\"))\n";
	    	  jscode+="{\n";
	    	  if(map.get("filename2") == null||"".equals(map.get("filename2"))) {
	    		  jscode+="document.getElementById(\"txt2\").src=\"/qzzp_sys/js/wujianli.jpg"+"\";\n";
	    	  }else {
	    		  jscode+="document.getElementById(\"txt2\").src=\"/qzzp_sys/js/youjianli.jpg"+"\";\n";
	    	  }
	    	  ...
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt3\").src=\"/qzzp_sys/upfile/"+map.get("filename3")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt4\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt4\").src=\"/qzzp_sys/upfile/"+map.get("filename4")+"\";\n";
	    	  jscode+="}\n";
	    	  
	    	  jscode+="if(document.getElementById(\"txt5\"))\n";
	    	  jscode+="{\n";
	    	  jscode+="document.getElementById(\"txt5\").src=\"/qzzp_sys/upfile/"+map.get("filename5")+"\";\n";
	    	  jscode+="}\n";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/qzzp_sys/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/qzzp_sys/js/popupsext.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/qzzp_sys/js/nopic.jpg\" id=txt2 height=\""+height+"\"/>";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg3()\" src=\"/qzzp_sys/js/nopic.jpg\" id=txt3 height=\""+height+"\"/>";
	...
	public static String getImgUpInfo(int height)
	{
		...
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/qzzp_sys/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/qzzp_sys/js/popups.js\"></script>";
		return jscode;
	}
	...
	public static String getImgUpInfo2(int height)
	{
		...
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg2()\" src=\"/qzzp_sys/js/nopic.jpg\" id=txt2 height=\""+height+"\"/>";
		jscode+="<input type=hidden name=\"filename2\" id=\"filename2\" value=\"\" />";
		jscode+="<script type=\"text/javascript\"  src=\"/qzzp_sys/js/popup.js\"></script>";
		return jscode;
	}
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg4()\" src=\"/qzzp_sys/js/nopic.jpg\" id=txt4 height=\""+height+"\"/>";
	...
	{
		String jscode = "";
		jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg5()\" src=\"/qzzp_sys/js/nopic.jpg\" id=txt5 height=\""+height+"\"/>";
	...
	public static String fck(int height,String content)
	{
		...
		jscode+="<script type=\"text/javascript\"  src=\"/qzzp_sys/fckeditor/fckeditor.js\"></script>";
		jscode+="<script language=\"javascript\">";
		jscode+="function fckinit()";
		jscode+="{";
		jscode+=" var of = new FCKeditor(\"content\");";
		jscode+="of.BasePath=\"/qzzp_sys/fckeditor/\";";
