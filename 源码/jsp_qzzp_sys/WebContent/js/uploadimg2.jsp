...
<LINK 
href="/qzzp_sys/admin/images/syscome.files/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/qzzp_sys/admin/images/syscome.files/Admin.js"></SCRIPT>
...
if(filename!=null)
{
 ...
 txt.src="/qzzp_sys/upfile/<%=filename%>";
 popclose();
 </script>
 <%} %>
<form action="/qzzp_sys/qzzp_sys?ac=uploadimg2" enctype="multipart/form-data" name="f1" method="post">
...
if(suc!=null)
{
 %>
 alert("操作成功");
  parent.location.replace("/qzzp_sys/admin/kcfiles.jsp");
 <%}%>
 </script>
