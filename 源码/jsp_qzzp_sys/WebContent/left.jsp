...
<TD vAlign=top width=196>
                  <TABLE border=0 cellSpacing=0 cellPadding=0 width="100%">
                    <TBODY>
                    <TR>
                      <TD background="qzzp_sys_files/index_zlm.jpg" height="35" align="left">
                      <font color="white"><strong>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;用户登录</strong></font></TD></TR>
                    <TR>
                      <TD background=qzzp_sys_files/index_zlmbj.jpg 
                        align=middle>
                        
                          <form name="form1" action="/qzzp_sys/qzzp_sys?ac=mlogin">
                        ...
                        width="90%" align=center>
                          ...
                          <TR>
                            ...
                            background=qzzp_sys_files/index_dx.jpg 
                          align=left></TD></TR>
                          ...
                          window.location.replace("/qzzp_sys");
                          </script>
                          <%
                          }
                           %>
...
<input type="reset" value="重置" style="border:2px" /></TD>
                          ...
                          <%}else{ %>
                           <TR>
                            <TD class=css height=33 
                             ...
                             <a href="/qzzp_sys/admin/main.jsp">去信息服务中心</a>
                  ...
                  <!-- 
                    <TR>
                      <TD align=left height="41" background="qzzp_sys_files/index_zlm1.jpg" >
                      &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<strong><font color="white">联系我们</font></strong>
                      
                      </TD></TR>
                    <TR>
                      <TD background=qzzp_sys_files/index_zlmbj1.jpg 
                    ...
                    <TR>
                      <TD height=62 background=qzzp_sys_files/index_zlmbj1.jpg 
                      align=middle>
                      ...
                      <A 
                        ...
                        src="qzzp_sys_files/index_zlm2.jpg" width=186 
