...
%>
<body>
	<form action="zpinfotj.jsp?f=f&tglparentid=<%=tglparentid%>" name="f1"
						...
						<tr>
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp;<span id="xldanx"><label><input
										type=radio checked=checked name='xl' id='xl' value='高中' />&nbsp;高中
								</label> <label><input type=radio name='xl' id='xl' value='大专' />&nbsp;大专
								</label> <label><input type=radio name='xl' id='xl' value='本科' />&nbsp;本科
								</label> <label><input type=radio name='xl' id='xl' value='硕士' />&nbsp;硕士
								</label> <label><input type=radio name='xl' id='xl' value='博士' />&nbsp;博士
								</label> </span></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
						...
						<tr>
							...
							<td width="79%" height="30" align="left" bgcolor="#FFFFFF"
								class="STYLE19">&nbsp;<span id="infotypedanx"><label><input
										type=radio checked=checked name='infotype' id='infotype'
										value='社会招聘' />&nbsp;社会招聘 </label> <label><input type=radio
										name='infotype' id='infotype' value='定向招聘' />&nbsp;定向招聘 </label> <label><input
										type=radio name='infotype' id='infotype' value='校园招聘' />&nbsp;校园招聘
								</label> </span></td>
						</tr>
						<tr>
							<td width="21%" height="30" align="center" bgcolor="#FFFFFF"
