          ...
          <tr>
            <td><table width="100%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                ...
                <td width="97%" valign="bottom"><span class="STYLE1"> 友情广告</span></td>
              </tr>
            </table></td>
            <td> 
...
&nbsp;&nbsp;广告名称 &nbsp;:&nbsp; <input type=text class=''  size=20 name='ljname' />&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
&nbsp;<input type=submit class='' value='查询信息' /> &nbsp;&nbsp;<input type=button   class=''  value='添加信息' onclick="add();" /> &nbsp;&nbsp;</td>
        </tr>
      
      
      <tr bgcolor="#F3F8F7">
        <td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >广告名称</td>
<td height="30" align="center"  style="background-color: #F3F8F7;color:#344B50;"  >广告地址</td>
...
<script language=javascript> 
function update(no){ 
pop('yqljxg.jsp?id='+no,'信息修改',1000,1000) 
}
</script> 
<script language=javascript> 
function add(){ 
pop('yqljtj.jsp','信息添加',550,550) 
}
</script> 
<%@page import="util.Info"%> 
