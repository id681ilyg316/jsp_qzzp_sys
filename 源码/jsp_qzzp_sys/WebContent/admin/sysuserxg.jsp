...
%>
<body>
<form  action="sysuserxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
...
if(unameobj.value!=""){  
var ajax = new AJAX(); 
ajax.post("/qzzp_sys/factory/checkno.jsp?table=sysuser&col=uname&value="+unameobj.value+"&checktype=update&id=<%=mmm.get("id")%>&ttime=<%=Info.getDateStr()%>"); 
