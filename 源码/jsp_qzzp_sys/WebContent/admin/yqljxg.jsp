...
%>
<body>
	<form action="yqljxg.jsp?f=f&id=<%=mmm.get("id")%>" name="f1"
...
<script language=javascqzzp_sysc='/lyshand/js/My97DatePicker/WdatePicker.js'></script>
<script language=javasqzzp_sysrc='/lyshand/js/ajax.js'></script>
<script language=javaqzzp_syssrc='/lyshand/js/popup.js'></script>
