...
<LINK 
href="/qzzp_sys/commfiles/css/Admin.css" rel=stylesheet>
<SCRIPT language=javascript src="/qzzp_sys/commfiles/js/Admin.js"></SCRIPT>
...
<form action="/qzzp_sys/qzzp_sys?ac=addxspl" name="f1" onsubmit="return ck()" enctype="multipart/form-data" > 
...
if(suc!=null)
{
 %>
 alert("操作成功");
  parent.location.replace("/qzzp_sys/admin/byssysusercx.jsp");
 <%}%>
