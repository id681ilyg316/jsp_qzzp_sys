...
pop('zxjltj.jsp','信息添加',550,'100%') 
      ...
      {
        var ajax = new AJAX();
        ajax.post("/qzzp_sys/factory/getsonops.jsp?ctype=tchat&id=<%=id%>&touname=<%=new CommDAO().getmap(id,"zxjl").get("touname")%>&tname=<%=tname%>&tcontent="+document.getElementById("tcontent").value);
      ...
      var tk = "";
        var ajax = new AJAX();
        ajax.post("/qzzp_sys/factory/getsonops.jsp?ctype=chat&id=<%=id%>&tname=<%=tname%>");
