...
%>
<body>
<form  action="cbxsysuserxg.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
...
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">专业名称<a href="javascript:alert('专业名称请用全称！');">注意</a></td>
...
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">简历</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<%=Info.getImgUpInfo2(65)%></td>
        </tr>
