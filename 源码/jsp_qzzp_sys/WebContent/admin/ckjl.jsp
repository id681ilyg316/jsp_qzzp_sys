...
%>
<body>
<form  action="ckjl.jsp?f=f&id=<%=mmm.get("id")%>"  name="f1" onSubmit="return checkform()">
...
<tr>
        <td width="17%" height="30" align="center" bgcolor="#FFFFFF" class="STYLE19">简历下载</td>
        <td width="83%" height="30" align="left" bgcolor="#FFFFFF" class="STYLE19">&nbsp;<a href="/qzzp_sys/upfile/<%=mmm.get("filename2")%>" target="_blank">下载简历</a></td>
        </tr>
	   <tr>
